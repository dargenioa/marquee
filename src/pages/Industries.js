  ...
  const getData = () => {
    fetch("./data.json", {
      ...
      .then(function (data) {
        ...
        setBackgroundImage(data.pages[0].blocks[0].background);
        setHeadline(data.pages[0].blocks[0].headline);
        setSubhead(data.pages[0].blocks[0].subhead);
        setCta(data.pages[0].blocks[0].cta);
      });
  };
